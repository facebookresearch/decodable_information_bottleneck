...
# Goal : 
# - Select the best architecture for Bob. Test when bob not using joint.

experiment="QminArchitectureBob"
...
col_val_subset.encoder=[resnet18,mlp,mlpxl]
