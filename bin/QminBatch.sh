...
# Goal : Compare effect of batch size on ERM, VIB, DIB
# Hypothesis
#   - the larger the batch the worst generalization

experiment="QminBatch"
...
col_val_subset.datasize=[b64,b128,b256,b512]
