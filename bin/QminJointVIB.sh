...
# Goal : Compare effect of VIB and DIB
# Hypothesis
#   - DIB better

experiment="QminJointVIB"
...
kwargs_multi="
run=0,1,2
model.loss.beta=1e-4,0.001,0.01,0.1,1,10
model=dib,vib
"
...
col_val_subset.beta=[1e-4,0.001,0.01,0.1,1,10]
"
...
python aggregate.py \
       ...
       plot_aux_trnsf.xticks=[1e-4,0.001,0.01,0.1,1,10]\
       ...
       plot_superpose.xticks=[1e-4,0.001,0.01,0.1,1,10]\
...
python aggregate.py \
       ...
       plot_metrics.xticks=[1e-4,0.001,0.01,0.1,1,10]\
