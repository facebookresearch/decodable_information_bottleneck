...
# Goal : 
# - Select the best learning rate. Test when bob not using joint.
...
kwargs_multi="
run=0,1,2
model.loss.beta=0,1,10,100,1000
train.kwargs.lr=1e-4,5e-5,1e-5
model=cdib,vib
"
...
col_val_subset.lr=[1e-4,5e-5,1e-5]
...
col_val_subset.beta=[0,1,10,100,1000]
"
...
python aggregate.py \
       ...
       plot_metrics.col=lr \
       plot_metrics.xticks=[0,1,10,100]\
