...
col_val_subset.model=[dib,dibsameidcs]
...
python aggregate.py \
       ...
       plot_aux_trnsf.xticklabels=[1,3,5,10]\
...
python aggregate.py \
       ...
       plot_metrics.xticklabels=[1,3,5,10]\
       plot_histories.col=mchead \
       plot_histories.style=model \
