...
kwargs_multi="
run=0,1,2,3,4
model.Q_zy.hidden_size=1,2,4,8,16,128
model.Q_zx.hidden_size=1,2,4,8,16,128
"
...
do
  ...
  python load_models.py $kwargs \
        ...
        load_models.recolt_data.encoders_vals=[1,2,4,8,16,128] \
...
col_val_subset.enc_zy_nhid=[1,2,4,8,16,128] 
col_val_subset.enc_zx_nhid=[1,2,4,8,16,128] 
"
...
python aggregate.py \
       ...
       plot_metrics.xticks=[1,2,4,8,16,128] \
