...
experiment="Qminimality2DBetasMMNoadd"
...
kwargs_multi="
run=0,1,2
model=cdibbatchnormhigher,cdibbatchnormexact,vib
model.loss.beta=0.01,0.1,1
"
...
do
for model in "cdibbatchnormhigher" "cdibbatchnormexact" "vib"
do
