...
kwargs_multi="
run=0,1,2,3,4
model=cdibXL,cdibXS,cdib,cdibexact,cdib3,cdib03,stochasticErm,vib
...
do
for model in "cdibXL"   "cdibXS" "cdibexact" "cdib3" "cdib" "vib" "stochasticErm"
do
