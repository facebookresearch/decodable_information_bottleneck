...
experiment="Qminimality2DTestLarge"
...
train.trnsf_kwargs.max_epochs=1
train.clf_kwargs.max_epochs=50
...
for Qzy in "128"  
do
for model in "cdib"   "stochasticErm" 
do
...
col_val_subset.model=[cdib,stochasyicErm]
