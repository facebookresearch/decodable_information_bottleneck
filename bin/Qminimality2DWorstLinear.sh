...
experiment="Qminimality2DWorstLinear"
...
model=cdibsklearn,cdibhigher,stochasticErm
...
col_val_subset.model=[cdibsklearn,cdibhigher,stochasticErm]
...
for Qzy in "128"  
do
for model in "cdibsklearn"   "stochasticErm" "cdibsklearn" 
do
