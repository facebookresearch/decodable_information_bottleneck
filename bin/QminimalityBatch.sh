...
# Goal : Show the effect of batch size

experiment="QminimalityBatch"
...
datasize=b16,b64,b256,b1024,b4096
"
#model.loss.altern_minimax=0,1,3,5,10,20
...
col_val_subset.datasize=[b16,b64,b256,b1024,b4096]
