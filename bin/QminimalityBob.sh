...
# Goal : 
# - Effect of Bobs architecture on Q minimality

experiment="QminimalityBob"
...
params="col_val_subset.encoder=[cifar10]
col_val_subset.lr=[5e-5]
col_val_subset.model=[cdib,vib]
col_val_subset.encoder=[mlpl,mlp,mlpxl,resnet18]
