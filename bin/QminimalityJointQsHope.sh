...
experiment="QminimalityJointQsHope"
...
import glob, shutil
old = "-0.1"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/QminimalityJointQsHope/**/gamma_{}/**/transformer".format(old)
...
END
    ...
    python main.py $kwargs $kwargs_multi $kwargs1 clfs.gamma_force_generalization=-0.1,-1 -m &
