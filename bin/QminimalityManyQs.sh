...
kwargs_multi="
run=0,1,2
model.loss.beta=0,100,1000
model.Q_zx.hidden_size=2,8,32,128,512,4028
"
...
col_val_subset.beta=[0,0.01,0.03,0.1,0.3,1,3,10,100,1000]
"

params=$params" col_val_subset.enc_zx_nhid=[2,8,32,128,512,4028] "
...
python aggregate.py \
       ...
       plot_generalization.style=enc_zx_nhid \
       plot_aux_trnsf.x=beta \
       plot_aux_trnsf.style=enc_zx_nhid \
...
python aggregate.py \
       ...
       plot_generalization.style=enc_zx_nhid \
       plot_metrics.x=beta \
       plot_metrics.style=enc_zx_nhid \
