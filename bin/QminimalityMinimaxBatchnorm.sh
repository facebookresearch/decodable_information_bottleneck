...
experiment="QminimalityMinimaxBatchnorm"
...
kwargs_multi="
run=0,1,2
model.loss.beta=0.001,0.01,0.1,1,10,100,1000
model.loss.altern_minimax=0,1,5,10
...
col_val_subset.minimax=[0,1,5,10]
col_val_subset.mchead=[1]
col_val_subset.beta=[0.001,0.01,0.1,1,10,100,1000]
"
