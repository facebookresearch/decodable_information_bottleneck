...
# Goal : Show the effect of the number of minimax step  when training until the end
# Hypothesis
#   - doing more steps of minimax ahould help generalization but then plateau

experiment="QminimalityMinimaxLast"
...
model.loss.altern_minimax=0,3,10,20
"
...
col_val_subset.minimax=[0,3,10,20]
