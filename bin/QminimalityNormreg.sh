...
# Goal : See effect of using norm reg scled by beta or not

experiment="QminimalityNormreg"
...
train.kwargs.is_continue_train=True
$dev
"
...
col_val_subset.model=[cdib,cdibcnstnorm]
