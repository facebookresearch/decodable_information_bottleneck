...
# Goal : Compare effect of different Q minimality for worst case Alice on dew data

experiment="QminimalityQsFinalNewdata"
...
kwargs_multi="
run=0,1,2,3,4
model.loss.beta=0,0.0001,0.001,0.01,0.1,1,10,100,1000
...
if [ "$is_plot_only" = false ] ; then
  ...
  do
    ...
    python main.py $kwargs $kwargs_multi $kwargs1 dataset.train=valid -m &
...
col_val_subset.beta=[0,0.0001,0.001,0.01,0.1,1,10,100,1000]
"
