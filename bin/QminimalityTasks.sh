...
import glob, shutil
old = "default"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/QminimalityTasks/**/clfs_{}/**/transformer".format(old)
folders=glob.glob(pattern, recursive=True)

for new in ["avg","distractor","worst"]:
...
col_val_subset.clfs=[distractor,default]
"
