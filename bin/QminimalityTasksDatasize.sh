...
experiment="QminimalityTasksDatasize"
...
import glob, shutil
old = "default"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/QminimalityTasksDatasize/**/clfs_{}/**/transformer".format(old)
...
END
    ...
    for kwargs2 in  "clfs=default datasize=all,small clfs.gamma_force_generalization=-0.1" "clfs=random datasize=small"
    do
      python main.py $kwargs $kwargs_multi $kwargs2  -m &
...
col_val_subset.datasize=[all,small]
