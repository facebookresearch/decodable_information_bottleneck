...
experiment="QminimalityTasksMinsuff"
...
import glob, shutil
old = "default"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/QminimalityTasksMinsuff/**/clfs_{}/**/transformer".format(old)
...
col_val_subset.model=[cdib,vib,minsuff]
col_val_subset.encoder=[mlpl]
col_val_subset.zdim=[10]
col_val_subset.beta=[0,0.01,0.1,1,10,100,1000]
"
