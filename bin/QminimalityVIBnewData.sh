...
experiment="QminimalityVIBnewData"
...
kwargs_multi="
run=0,1,2
model.loss.beta=0,0.01,0.1,1,10,100,1000
model=cdib,vib,cdibL,cdibS,cdibhigher,cdibjoint
...
if [ "$is_plot_only" = false ] ; then
  ...
  do
    ...
    python main.py $kwargs $kwargs_multi dataset.train=valid $kwargs1 -m &
...
col_val_subset.model=[cdib,vib,cdibL,cdibS,cdibhigher,cdibjoint]
