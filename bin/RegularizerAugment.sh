...
import glob, shutil
old = "last"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/RegularizerAugment/**/chckpnt_{}/**/transformer".format(old)
