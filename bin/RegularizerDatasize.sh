...
# Goal : See how well we do as a regularizer for different datasizes.

experiment="RegularizerDatasize"
...
import glob, shutil
old = "last"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/RegularizerDatasize/**/chckpnt_{}/**/transformer".format(old)
