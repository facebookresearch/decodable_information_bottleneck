...
# Goal : See how well we do as a regularizer for different lr.

experiment="RegularizerLr"
...
train.kwargs.lr=1e-3,1e-4,1e-5
"
...
import glob, shutil
old = "last"
pattern = "/private/home/yannd/projects/Decodable_Information_Bottleneck/tmp_results/dev_RegularizerLr/**/chckpnt_{}/**/transformer".format(old)
...
col_val_subset.lr=[1e-3,1e-4,1e-5]
