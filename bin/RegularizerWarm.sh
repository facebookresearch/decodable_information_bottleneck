...
# Goal : Compare effect of warmin up Q_zx
# Hypothesis : 1 better than 0 but then changes nothing

experiment="RegularizerWarm"
...
col_val_subset.model=[warm0,warm1,warm3,warm5]
