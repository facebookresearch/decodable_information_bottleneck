...
experiment="coloredmnist001betas"
...
kwargs_multi="
run=0,1,2
model=cdibhigher,simplecdibdet
dataset=coloredmnist
model.loss.beta=0,0.1,0.3,1,3,10,30,100,1000,10000
"
#train.kwargs.lr=5e-5,1e-5
...
params="col_val_subset.data=[coloredmnist]
col_val_subset.lr=[5e-5]
col_val_subset.beta=[0,0.1,0.3,1,3,10,30,100,1000,10000]
col_val_subset.model=[cdibhigher,simplecdibdet]
