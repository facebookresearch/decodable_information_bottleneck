...
# Goal : See whether lr of z is correlated with generalization gap and decodable info for alice training on new data

experiment="corrLrAlice"
...
python aggregate.py \
       ...
       plot_gplot_metricseneralization.x=lr \
