...
# copying the folder 
base="tmp_results/corrResnetsHq"
...
params="col_val_subset.data=[svhn,cifar10]
...
col_val_subset.encoder=[resnet18,resnet34,resnet50,resnet101]
