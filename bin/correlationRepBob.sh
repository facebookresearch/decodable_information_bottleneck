...
kwargs_multi="
encoder=cnnninw2d2,cnnninw2d4,cnnninw2d8,cnnninw4d2,cnnninw4d4,cnnninw4d8,cnnninw8d2,cnnninw8d4,cnnninw8d8
train.kwargs.lr=1e-3,3.2e-4,1e-4
datasize=b32,b64,b128
model.dropout=0,0.25,0.5
train.weight_decay=0,0.0001,0.0005
train.optim=rmsprop,sgd,adam
"
