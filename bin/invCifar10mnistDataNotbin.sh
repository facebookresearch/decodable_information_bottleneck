...
experiment="invCifar10mnistDataNotbin"
...
run=0,1,2
model=cdibquick
dataset=cifar10mnistdep5,cifar10mnistdep3,cifar10mnistdep7,cifar10mnistdep8,cifar10mnistdep9
...
params="col_val_subset.data=[cifar10mnistdep5,cifar10mnistdep3,cifar10mnistdep7,cifar10mnistdep8,cifar10mnistdep9]
