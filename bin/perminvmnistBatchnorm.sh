...
experiment="perminvmnistBatchnorm"
...
kwargs_multi="
run=0,1,2,3,4
model=batchnorm,cdibbatchnormhigher,cdibbatchnormhigher01,cdibbatchnormjoint,cdibbatchnormjoint01,wdecay,cdibbatchnormzxhigher,cdibbatchnormzxhigher01
"
