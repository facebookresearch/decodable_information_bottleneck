...
run=0,1,2,3,4
dataset=mnist
model=simplecdib,simplecdibdet,simplecdibexact,simplevcdib,vcdib,cdib,cdibhigher
train.monitor_best=last,vloss
model.loss.beta=0.1,0.3,1,3,10
"
