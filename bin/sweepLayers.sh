...
train.clf_kwargs.max_epochs=150
...
params=$params" col_val_subset.clf_nlay=[1,2,3,4,5] 
col_val_subset.clf_kpru=[0] 
col_val_subset.clf_nhid=[128]
"
...
python aggregate.py \
       ...
       $params \
       plot_metrics.x=clf_nlay \
       plot_metrics.style=zdim \
       plot_metrics.xticks=[1,2,3,4,5] \
       plot_metrics.xticklabels=[1,2,3,4,5] \
       plot_histories.style=zdim \
       plot_histories.col=clf_nlay \
