...
# Goal : Sweep over depth over neural nets.

experiment="sweepSparse"
...
params=$params" col_val_subset.clf_nlay=[3] 
col_val_subset.clf_kpru=[0,2,4,6,8] 
col_val_subset.clf_nhid=[2048]
"
...
python aggregate.py \
       ...
       $params \
       plot_metrics.x=clf_kpru \
       plot_metrics.style=zdim \
       plot_metrics.xticks=[8,6,4,2,0] \
       plot_metrics.xticklabels=["0.4%","1.6%","6.3%","25%","100%"] \
       plot_histories.style=zdim \
       plot_histories.col=clf_kpru \
